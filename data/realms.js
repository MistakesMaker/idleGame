        ...
        zones: {
            "green_meadows": {
                ...
                subZones: {
                    ...
                    "royal_vanguard": { name: "Royal Vanguard", levelRange: [75, 75], monsterPool: [MONSTERS.GRIFFIN_CHICK], coords: {top: '20%', left: '60%'}, isBoss: true }, // Changed boss to fit tier
            ...
            "orc_volcano": {
                ...
                subZones: {
                    ...
                    // Tier 3 (Levels 151-199)
                    "charred_forest": { name: "Charred Forest", levelRange: [151, 174], monsterPool: [MONSTERS.FIRE_ELEMENTAL, MONSTERS.SALAMANDER, MONSTERS.ORC_BERSERKER], coords: {top: '50%', left: '45%'} },
                    ...
                    "volcanos_maw": { name: "Volcano's Maw", levelRange: [176, 199], monsterPool: [MONSTERS.ORC_BERSERKER, MONSTERS.FIRE_ELEMENTAL, MONSTERS.SALAMANDER], coords: {top: '20%', left: '30%'} },
