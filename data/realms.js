...
export const REALMS = [
    {
        ...
        zones: {
            "green_meadows": {
                ...
                subZones: {
                    "verdant_fields": { name: "Verdant Fields", levelRange: [1, 24], monsterPool: [MONSTERS.SLIME, MONSTERS.GOBLIN, MONSTERS.WILD_BOAR, MONSTERS.FOREST_SPRITE], coords: {top: '80%', left: '15%'} },
                    ...
                    "whispering_woods": { name: "Whispering Woods", levelRange: [26, 49], monsterPool: [MONSTERS.WOLF, MONSTERS.BAT, MONSTERS.GIANT_SPIDER, MONSTERS.TREANT_SPROUT], coords: {top: '75%', left: '45%'} },
                    ...
                    "sun_dappled_hills": { name: "Sun-dappled Hills", levelRange: [51, 74], monsterPool: [MONSTERS.HOBGOBLIN, MONSTERS.WILD_BOAR, MONSTERS.GRIFFIN_CHICK], coords: {top: '35%', left: '40%'} },
                    ...
                    "royal_hunting_grounds": { name: "Royal Hunting Grounds", levelRange: [76, 99], monsterPool: [MONSTERS.WOLF, MONSTERS.HOBGOBLIN, MONSTERS.TREANT_SPROUT], coords: {top: '30%', left: '85%'} },
            ...
            "orc_volcano": {
                ...
                subZones: {
                    "ashfall_plains": { name: "Ashfall Plains", levelRange: [101, 124], monsterPool: [MONSTERS.ORC, MONSTERS.MAGMA_SLIME, MONSTERS.SALAMANDER], coords: {top: '80%', left: '20%'} },
                    "orc_watchtower": { name: "Orc Watchtower", levelRange: [125, 125], monsterPool: [MONSTERS.GIANT_ORC], coords: {top: '80%', left: '50%'}, isBoss: true },
                    "scorched_path": { name: "Scorched Path", levelRange: [126, 149], monsterPool: [MONSTERS.ORC_BERSERKER, MONSTERS.ORC_SHAMAN, MONSTERS.FIRE_ELEMENTAL], coords: {top: '80%', left: '80%'} },
                    "molten_heart": { name: "Molten Heart", levelRange: [150, 150], monsterPool: [MONSTERS.OBSIDIAN_GOLEM], coords: {top: '50%', left: '75%'}, isBoss: true },
                    "charred_forest": { name: "Charred Forest", levelRange: [151, 174], monsterPool: [MONSTERS.ORC_SHAMAN, MONSTERS.LAVA_TURTLE, MONSTERS.FIRE_ELEMENTAL], coords: {top: '50%', left: '45%'} },
                    ...
                    "volcanos_maw": { name: "Volcano's Maw", levelRange: [176, 199], monsterPool: [MONSTERS.ORC_BERSERKER, MONSTERS.SALAMANDER, MONSTERS.MAGMA_SLIME], coords: {top: '20%', left: '30%'} },
            ...
            "undead_desert": {
                ...
                subZones: {
                     "lost_tombs": { name: "Lost Tombs", levelRange: [201, 224], monsterPool: [MONSTERS.SKELETON, MONSTERS.GHOUL, MONSTERS.TOMB_ROBBER], coords: {top: '85%', left: '15%'} },
                     "mummy_crypt": { name: "Mummy's Crypt", levelRange: [225, 225], monsterPool: [MONSTERS.CURSED_MUMMY], coords: {top: '85%', left: '45%'}, isBoss: true },
                     "shifting_sands": { name: "Shifting Sands", levelRange: [226, 249], monsterPool: [MONSTERS.ZOMBIE, MONSTERS.GIANT_SCORPION, MONSTERS.VULTURE], coords: {top: '85%', left: '75%'} },
                     ...
                     "scorpion_nest": { name: "Scorpion Nest", levelRange: [251, 274], monsterPool: [MONSTERS.GIANT_SCORPION, MONSTERS.SKELETAL_ARCHER, MONSTERS.SAND_WRAITH], coords: {top: '50%', left: '50%'} },
                     ...
                     "endless_dunes": { name: "Endless Dunes", levelRange: [276, 299], monsterPool: [MONSTERS.ZOMBIE, MONSTERS.SAND_WRAITH, MONSTERS.VULTURE], coords: {top: '20%', left: '30%'} },
            ...
            "final_dungeon": {
                ...
                subZones: {
                    "gatehouse": { name: "The Gatehouse", levelRange: [301, 324], monsterPool: [MONSTERS.GARGOYLE, MONSTERS.IMP, MONSTERS.HELLHOUND], coords: {top: '80%', left: '20%'} },
                    "demon_sentry": { name: "Demon Sentry", levelRange: [325, 325], monsterPool: [MONSTERS.PIT_FIEND], coords: {top: '80%', left: '50%'}, isBoss: true },
                    "halls_of_damnation": { name: "Halls of Damnation", levelRange: [326, 349], monsterPool: [MONSTERS.SUCCUBUS, MONSTERS.CULTIST], coords: {top: '80%', left: '80%'} },
                    "the_hellforge": { name: "The Hellforge", levelRange: [350, 350], monsterPool: [MONSTERS.CHAOS_DEMON], coords: {top: '50%', left: '75%'}, isBoss: true },
        ...
        zones: {
             "crystal_caves": {
                ...
                subZones: {
                    ...
                    "deep_caverns": { name: "Deep Caverns", levelRange: [451, 474], monsterPool: [MONSTERS.CRYSTAL_SPIDER, MONSTERS.CAVE_LURKER], coords: {top: '50%', left: '45%'} },
                    "ancient_horror": { name: "Ancient Horror", levelRange: [475, 475], monsterPool: [MONSTERS.CRYSTAL_GOLEM], coords: {top: '50%', left: '15%'}, isBoss: true },
                    "geode_chamber": { name: "Geode Chamber", levelRange: [476, 499], monsterPool: [MONSTERS.SHARD_SLIME, MONSTERS.DEEP_GNOME_MINER], coords: {top: '20%', left: '30%'} },
            ...
            "fungal_forest": {
                ...
                subZones: {
                    ...
                    "mycelial_network": { name: "Mycelial Network", levelRange: [526, 549], monsterPool: [MONSTERS.FUNGAL_CRAWLER, MONSTERS.GAS_SPORE], coords: {top: '80%', left: '80%'} },
                    "fungal_behemoth_cave": { name: "Fungal Behemoth's Cave", levelRange: [550, 550], monsterPool: [MONSTERS.FUNGAL_BEHEMOTH], coords: {top: '50%', left: '75%'}, isBoss: true },
                    "shrieking_hollows": { name: "Shrieking Hollows", levelRange: [551, 574], monsterPool: [MONSTERS.SPORE_BAT, MONSTERS.SHRIEKER], coords: {top: '50%', left: '45%'} },
                    "spore_lord": { name: "Spore Lord", levelRange: [575, 575], monsterPool: [MONSTERS.FUNGAL_BEHEMOTH], coords: {top: '50%', left: '15%'}, isBoss: true },
                    "great_fungus_approach": { name: "Great Fungus Approach", levelRange: [576, 599], monsterPool: [MONSTERS.MYCONID_SPOREKEEPER, MONSTERS.FUNGAL_CRAWLER], coords: {top: '20%', left: '30%'} },
            ...
            "drow_city": {
                ...
                subZones: {
                    ...
                    "drow_patrol": { name: "Drow Patrol", levelRange: [625, 625], monsterPool: [MONSTERS.DROW_PRIESTESS], coords: {top: '80%', left: '50%'}, isBoss: true },
                    "webbed_catacombs": { name: "Webbed Catacombs", levelRange: [626, 649], monsterPool: [MONSTERS.DRIDER, MONSTERS.GIANT_CAVE_SPIDER], coords: {top: '80%', left: '80%'} },
                    ...
                    "noble_district": { name: "Noble District", levelRange: [651, 674], monsterPool: [MONSTERS.DROW_MAGE, MONSTERS.SHADOW_STALKER], coords: {top: '50%', left: '45%'} },
                    "house_captain": { name: "House Captain", levelRange: [675, 675], monsterPool: [MONSTERS.DROW_PRIESTESS], coords: {top: '50%', left: '15%'}, isBoss: true },
                    "temple_of_lolth": { name: "Temple of Lolth", levelRange: [676, 699], monsterPool: [MONSTERS.DROW_MAGE, MONSTERS.DRIDER], coords: {top: '20%', left: '30%'} },
