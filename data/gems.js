...
export const GEMS = {
    ...
    BASE_RUBY: {
        ...
        width: 1, height: 1,
        stats: { [STATS.CLICK_DAMAGE.key]: 500 } // MODIFIED (was 250)
    },
    BASE_SAPPHIRE: {
        id: 'BASE_SAPPHIRE',
        ...
        width: 1, height: 1,
        stats: { [STATS.DPS.key]: 2000 } // MODIFIED (was 1000)
    },
    BASE_EMERALD: {
        id: 'BASE_EMERALD',
        name: 'T1 Gem (Emerald)',
    ...
    BASE_RUBY_T2: {
        ...
        width: 1, height: 1,
        stats: { [STATS.CLICK_DAMAGE.key]: 1000 } // MODIFIED (was 500)
    },
    BASE_SAPPHIRE_T2: {
        id: 'BASE_SAPPHIRE_T2',
        ...
        icon: 'images/gems/fused_t2.png',
        width: 1, height: 1,
        stats: { [STATS.DPS.key]: 4000 } // MODIFIED (was 2000)
    },
    BASE_EMERALD_T2: {
        id: 'BASE_EMERALD_T2',
        name: 'T2 Gem (Emerald)',
    ...
    // --- TIER 3 GEMS ---
    // ===================================
    BASE_RUBY_T3: { id: 'BASE_RUBY_T3', name: 'T3 Gem (Ruby)', type: 'ruby', tier: 3, icon: 'images/gems/fused_t3.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 2000 } },
    BASE_SAPPHIRE_T3: { id: 'BASE_SAPPHIRE_T3', name: 'T3 Gem (Sapphire)', type: 'sapphire', tier: 3, icon: 'images/gems/fused_t3.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 8000 } },
    ...
    // --- TIER 4 GEMS ---
    // ===================================
    BASE_RUBY_T4: { id: 'BASE_RUBY_T4', name: 'T4 Gem (Ruby)', type: 'ruby', tier: 4, icon: 'images/gems/fused_t4.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 4000 } },
    BASE_SAPPHIRE_T4: { id: 'BASE_SAPPHIRE_T4', name: 'T4 Gem (Sapphire)', type: 'sapphire', tier: 4, icon: 'images/gems/fused_t4.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 16000 } },
    ...
    // --- TIER 5 GEMS ---
    // ===================================
    BASE_RUBY_T5: { id: 'BASE_RUBY_T5', name: 'T5 Gem (Ruby)', type: 'ruby', tier: 5, icon: 'images/gems/fused_t5.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 8000 } },
    BASE_SAPPHIRE_T5: { id: 'BASE_SAPPHIRE_T5', name: 'T5 Gem (Sapphire)', type: 'sapphire', tier: 5, icon: 'images/gems/fused_t5.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 32000 } },
    ...
    // --- TIER 6 GEMS ---
    // ===================================
    BASE_RUBY_T6: { id: 'BASE_RUBY_T6', name: 'T6 Gem (Ruby)', type: 'ruby', tier: 6, icon: 'images/gems/fused_t6.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 16000 } },
    BASE_SAPPHIRE_T6: { id: 'BASE_SAPPHIRE_T6', name: 'T6 Gem (Sapphire)', type: 'sapphire', tier: 6, icon: 'images/gems/fused_t6.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 64000 } },
    ...
    // --- TIER 7 GEMS ---
    // ===================================
    BASE_RUBY_T7: { id: 'BASE_RUBY_T7', name: 'T7 Gem (Ruby)', type: 'ruby', tier: 7, icon: 'images/gems/fused_t7.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 32000 } },
    BASE_SAPPHIRE_T7: { id: 'BASE_SAPPHIRE_T7', name: 'T7 Gem (Sapphire)', type: 'sapphire', tier: 7, icon: 'images/gems/fused_t7.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 128000 } },
    ...
    // --- TIER 8 GEMS ---
    // ===================================
    BASE_RUBY_T8: { id: 'BASE_RUBY_T8', name: 'T8 Gem (Ruby)', type: 'ruby', tier: 8, icon: 'images/gems/fused_t8.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 64000 } },
    BASE_SAPPHIRE_T8: { id: 'BASE_SAPPHIRE_T8', name: 'T8 Gem (Sapphire)', type: 'sapphire', tier: 8, icon: 'images/gems/fused_t8.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 256000 } },
    ...
    // --- TIER 9 GEMS ---
    // ===================================
    BASE_RUBY_T9: { id: 'BASE_RUBY_T9', name: 'T9 Gem (Ruby)', type: 'ruby', tier: 9, icon: 'images/gems/fused_t9.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 128000 } },
    BASE_SAPPHIRE_T9: { id: 'BASE_SAPPHIRE_T9', name: 'T9 Gem (Sapphire)', type: 'sapphire', tier: 9, icon: 'images/gems/fused_t9.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 512000 } },
    ...
    // --- TIER 10 GEMS ---
    // ===================================
    BASE_RUBY_T10: { id: 'BASE_RUBY_T10', name: 'T10 Gem (Ruby)', type: 'ruby', tier: 10, icon: 'images/gems/fused_t10.png', width: 1, height: 1, stats: { [STATS.CLICK_DAMAGE.key]: 256000 } },
    BASE_SAPPHIRE_T10: { id: 'BASE_SAPPHIRE_T10', name: 'T10 Gem (Sapphire)', type: 'sapphire', tier: 10, icon: 'images/gems/fused_t10.png', width: 1, height: 1, stats: { [STATS.DPS.key]: 1024000 } },
